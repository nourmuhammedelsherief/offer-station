                ...
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">إضافة قسم جديدة </span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ar_name" class="form-control" placeholder="أسم القسم بالعربي" value="{{old('ar_name')}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="en_name" class="form-control" placeholder="أسم القسم بالأنجليزي " value="{{old('en_name')}}" required>
