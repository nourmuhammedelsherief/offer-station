...
@section('page_header')
    ...
    <h1 class="page-title">عرض الأخبار
        <small>اضافة جميع الأخبار  </small>
    </h1>
@endsection
                ...
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">إضافة خبر  جديد </span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ar_title" class="form-control" placeholder="اكتب عنوان  الخبر باللغة العربية" value="{{old('ar_title')}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="en_title" class="form-control" placeholder="اكتب عنوان  الخبر باللغة الأنجليزية" value="{{old('en_title')}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" rows="5" name="ar_details" placeholder="أكتب تفاصيل  الخبر باللغه العربية" ></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" rows="5" name="en_details" placeholder="أكتب تفاصيل  الخبر باللغه الأنجليزية" ></textarea>
